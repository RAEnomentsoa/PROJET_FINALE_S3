...
use app\models\User;
use app\models\TestHabitationModele;
...
Flight::map('chauffeurModel', function () {
    return new chauffeurModel(Flight::db());
});

Flight::map('DepositsModel', function () {
    return new DepositsModel(Flight::db());
});

Flight::map('User', fn() => new User(Flight::db()));

Flight::map('DepositsModel', function () {
    return new DepositsModel(Flight::db());
});

Flight::map('AdminController', function () {
...
Flight::map('TestHabitationModel', function () {
    return new TestHabitationModele(Flight::db());
});
